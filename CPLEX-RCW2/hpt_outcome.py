...
outcome = pd.read_csv("./CPLEX-RCW2/Daten/hpt.csv", sep=";", header=0, names=headers)
...
#    g.fig.set_title("123", fontsize=200)
    ...
    plt.savefig(f"./CPLEX-RCW2/hpt_{arc}_architecture.pdf", dpi=300, format="pdf")